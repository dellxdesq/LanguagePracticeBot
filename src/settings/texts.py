...
hello_text = (f"Привет! Я бот для практики иностранного языка с искусственным интеллектом. "
              ...
              f"Чтобы сменить язык на нужный, напишите в чат соответствующю команду, языки которые доступны:\n\n"
              f"Испанский - /spanish \n\n"
...
goodbye_message = ("Goodbye! Чтобы поговорить снова на английском, напиши /start\n\n"
                   "Если захочешь сменить язык, напиши соответствующую команду\n\n"
                   "Испанский - /spanish")
